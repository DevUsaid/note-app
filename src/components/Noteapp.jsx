    ...
    <div className="flex m-10 gap-56 overflow-hidden">
      ...
      <form className="flex flex-col gap-3 w-96 ml-36 " onSubmit={stopFormload}>
       ...
       >Add Nots
        ...
        <input
          className="p-4 w-96 outline-none border text-black border-gray-500"
        ...
        <textarea
          className="p-4 h-52 outline-none text-black border border-gray-500"
